...
public class Assert {
	...
	*/
	...
	@param msg error message meant to describe the error
	*/
	public static void assertEquals(int expect, int result, String msg) {
		boolean match = true;
		// First test for nulls to avoid Exceptions
		if (expect != result) {
			System.out.println(msg+" Expect "+expect+". Result "+result);
	...
	*/
	...
	@param expect instance of Song to be matched.
	@param result instance of Song for comparison.
